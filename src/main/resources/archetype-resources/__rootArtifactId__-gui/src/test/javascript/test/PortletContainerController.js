...
Ext.define('test.PortletContainerController', {
    singleton: true,
    requires: ['${rootArtifactId}.controller.PortletContainer'],
        ...
        describe('PortletContainerController test', function () {
            ...
            it('should save the settings', function () {
                ...
                Ext.create = function (name, args) {
                    ...
                    if (name === '${rootArtifactId}.model.PanelSettings') {
                        obj.save = function () {
                            saveExecuted = true;
                ...
                var definition = classDefinitions['${rootArtifactId}.controller.PortletContainer'];
