...
(function () {
    ...
    Ext.define('${rootArtifactId}.controller.SystemThreads', {
        ...
        refs: [
            {
                ref: 'threadsView',
                selector: '${rootArtifactId}-threads-panel'
            }
        ],
        ...
        init: function () {
            ...
            store.on('beforeload', function () {
                self.getThreadsView().mask(${rootArtifactId}.i18n.get('loading.data'));
            });
