...
(function () {
    ...
    Ext.define('${rootArtifactId}.view.JvmMemory', {
        title: ${rootArtifactId}.i18n.get('application.system.jvm.memory'),
        extend: '${rootArtifactId}.ux.Chart',
        alias: 'widget.${rootArtifactId}-jvm-mem-panel',
        tools: [
            {
                itemId: 'refresh',
                type: 'refresh',
        ...
        tooltip: function (records) {
            var first = records[0];
            var template = ${rootArtifactId}.view.JvmMemory.tooltipTemplate;
