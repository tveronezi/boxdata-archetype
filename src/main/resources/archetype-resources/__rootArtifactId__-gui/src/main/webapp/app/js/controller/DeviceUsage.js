...
(function () {
    ...
    Ext.define('${rootArtifactId}.controller.DeviceUsage', {
        ...
        refs: [
            {
                ref: 'myView',
                selector: '${rootArtifactId}-device-usage-panel'
            }
        ],
        ...
        loadData: function () {
            var self = this;
            self.getMyView().mask(${rootArtifactId}.i18n.get('loading.data'));
        ...
        init: function () {
            ...
            self.control({
                '${rootArtifactId}-device-usage-panel': {
                    render: function () {
                        self.loadData();
                    },
